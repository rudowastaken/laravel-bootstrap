	...
	grunt.initConfig({
		...
		options: {
			...
			css: {
				...
				files: ['assets/css/less.css'],							// CSS files in order you'd like them concatenated and minified
			...
			js: {
				...
				files: ['assets/vendor/jquery/jquery.js','assets/vendor/bootstrap/dist/js/bootstrap.js','assets/js/main.js'],							// JavaScript files in order you'd like them concatenated and minified
